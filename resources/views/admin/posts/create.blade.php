        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail2" placeholder="" name="subtitle" value="{{old('subtitle')}}">
            </div>
            ...
            <div class="form-group">
              <label>
                <input type="checkbox" class="minimal" name="is_default">
              </label>
              <label>
                Черновик
              </label>
