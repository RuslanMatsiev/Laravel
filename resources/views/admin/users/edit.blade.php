    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Реадктируем пользователя</h3>
          <!-- Выводим ошибки -->
        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <img src="{{$user->getUserImage()}}" alt="" width="200" class="img-responsive">
              <label for="exampleInputFile">Аватар</label>
              <input type="file" name="userimage" id="exampleInputFile">
        ...
        <div class="box-footer">
          <!-- Возврат на страницу пользователей -->
