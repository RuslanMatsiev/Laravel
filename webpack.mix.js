...
mix.styles([
   'resources/assets/public/css/owl.carousel.css',
   'resources/assets/public/css/owl.theme.css',
   'resources/assets/public/css/owl.transitions.css',
   'resources/assets/public/css/style.css',
], 'public/css/front.css');

mix.scripts([
   'resources/assets/public/js/jquery-1.11.3.min.js',
   'resources/assets/public/js/owl.carousel.min.js',
], 'public/js/front.js');

mix.copy('resources/assets/public/img', 'public/images');